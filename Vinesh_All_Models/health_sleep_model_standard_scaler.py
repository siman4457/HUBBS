...
for i in range(0, len(unique)):
    ...
    for j in range(0, num_columns):
        ...
        x_scaled = standrd_scaler.fit_transform(x_floats)
        ...
        x_scaled_test = standrd_scaler.transform(x_floats_test)
    ...
    # for z in range(0, num_columns):
        # col_name = normalized_X.columns[z]
        # print(col_name)
        # print(normalized_X[col_name])
        # print(normalized_X[col_name])
        # print(y_train)
    ...
    # tryna do it not random so lets take 25% of the IDS
